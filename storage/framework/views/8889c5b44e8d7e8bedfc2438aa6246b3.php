...
} elseif ($_instance->childHasBeenRendered('5S13bs3')) {
    $componentId = $_instance->getRenderedChildComponentId('5S13bs3');
    $componentTag = $_instance->getRenderedChildComponentTagName('5S13bs3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5S13bs3');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('5S13bs3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('gptl9Eu')) {
    $componentId = $_instance->getRenderedChildComponentId('gptl9Eu');
    $componentTag = $_instance->getRenderedChildComponentTagName('gptl9Eu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gptl9Eu');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('gptl9Eu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\example\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>