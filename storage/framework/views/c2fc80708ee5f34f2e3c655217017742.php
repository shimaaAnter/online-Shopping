...
} elseif ($_instance->childHasBeenRendered('RZSgj1r')) {
    $componentId = $_instance->getRenderedChildComponentId('RZSgj1r');
    $componentTag = $_instance->getRenderedChildComponentTagName('RZSgj1r');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RZSgj1r');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('RZSgj1r', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\example\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>